...
const Crown = () => (
  <svg width="64" height="56" viewBox="0 0 64 56" fill="none">
    <defs>
      <linearGradient id="crownGrad" x1="0" y1="0" x2="64" y2="56">
        <stop offset="0%" stopColor="#FFE566" />
        <stop offset="40%" stopColor="#D4AF37" />
        <stop offset="100%" stopColor="#A07820" />
      </linearGradient>
      <linearGradient id="gemGrad" x1="0" y1="0" x2="6" y2="8">
    ...
    <path
      d="M6 44 L2 14 L16 26 L32 4 L48 26 L62 14 L58 44 Q57 47 54 47 L10 47 Q7 47 6 44Z"
      fill="url(#crownGrad)"
      stroke="#B8860B"
      strokeWidth="1.2"
      filter="url(#crownGlow)"
    />
    <rect x="6" y="44" width="52" height="6" rx="3" fill="#C49B20" stroke="#A07820" strokeWidth="0.8" />
    <circle cx="18" cy="47" r="2" fill="#FFE566" opacity="0.7" />
    <circle cx="32" cy="47" r="2" fill="#FFE566" opacity="0.7" />
    <circle cx="46" cy="47" r="2" fill="#FFE566" opacity="0.7" />
    <circle cx="16" cy="24" r="3" fill="#C41E3A" stroke="#8B0000" strokeWidth="0.8" />
    <circle cx="15.2" cy="23.2" r="1" fill="#FF8080" opacity="0.7" />
    <circle cx="48" cy="24" r="3" fill="#C41E3A" stroke="#8B0000" strokeWidth="0.8" />
    <circle cx="47.2" cy="23.2" r="1" fill="#FF8080" opacity="0.7" />
    <circle cx="32" cy="8" r="4" fill="url(#gemGrad)" stroke="#8B0000" strokeWidth="1" />
    <circle cx="30.5" cy="6.5" r="1.5" fill="#FF9090" opacity="0.8" />
  </svg>
);
